...
Transform your Windows 11 taskbar into a smooth, MacOS-style dock—without losing any of the original functionality! Unlike other solutions that rely on third-party apps, this mod enhances the native taskbar with sleek animations and customizability.
...
1. Copy the contents of [`assembled-mod.cpp`](https://raw.githubusercontent.com/DarkionAvey/windhawk-taskbar-centered-condensed/refs/heads/main/assembled-mod.cpp) to your clipboard.
2. Open **WindHawk** and navigate to: `Explore` → `Create a new mod`.
3. Press `Ctrl+A` to select all, then `Ctrl+V` to paste.
4. Click **Compile Mod**.

⚠️ **Note:** Please disable any mods that affect taskbar height or taskbar icons—this mod already includes those features.

---

## 🛠 Source Code

The actual mod code is located in [`mod-parts/docklike-mod.cpp`](https://github.com/DarkionAvey/windhawk-taskbar-centered-condensed/blob/main/mod-parts/docklike-mod.cpp). Other parts are automatically generated by a Python script.

❗ **Do not edit `assembled-mod.cpp` manually**, as any changes will be overwritten in the next build cycle. Instead, modify the source files in the `mod-parts` directory.
...
| --- | --- | --- | --- |
| `TrayTaskGap` | Tray task gap | Adjusts the space between the task area and the tray area (Default 10) | Integer (whole number) |
...
| `TaskbarIconSize` | Taskbar icon size | Defines the width and height of taskbar icons (Default 40) | Non-negative integer |
| `TaskbarButtonSize` | Taskbar button size | Sets the size of taskbar buttons, which surround the icons (Default 70) | Non-negative integer |
...
| `FlatTaskbarBottomCorners` | Flat bottom corners | If enabled, the bottom corners of the taskbar will be squared instead of rounded, and the taskbar will dock to the screen edge. This setting overrides the taskbar offset (Default false) | Boolean (true/false) |
...
- TrayTaskGap: 10
  $name: Tray task gap
  $description: Adjusts the space between the task area and the tray area (Default 10)
...
- TaskbarIconSize: 40
  ...
  $description: Defines the width and height of taskbar icons (Default 40)


- TaskbarButtonSize: 70
  $name: Taskbar button size
  $description: Sets the size of taskbar buttons, which surround the icons (Default 70)
...
- FlatTaskbarBottomCorners: false
  ...
  $description: If enabled, the bottom corners of the taskbar will be squared instead of rounded, and the taskbar will dock to the screen edge. This setting overrides the taskbar offset (Default false)
...
- TaskbarBorderOpacity: 30
  ...
  $description: Controls the opacity of the taskbar border. Range 0-100 (Default 30)


- TaskbarBorderColorHex: "#ffffff"
  $name: Taskbar border color (HEX)
  $description: Adjusts the color of the taskbar border. Hex color as \#RRGGBB
